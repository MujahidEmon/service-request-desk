...
const Homepage = () => {
    return (
        <div className='max-w-7xl min-h-screen mx-auto flex flex-col items-center justify-center md:gap-5 gap-4'>
            ...
            <div className='flex flex-col md:flex-row items-center justify-center gap-4'>
                <div className="card border border-primary/40 bg-base-100 w-full shadow-sm">
